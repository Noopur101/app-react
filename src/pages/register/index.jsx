...
const Register = () => {
  ...
  const validationSchema = Yup.object().shape({
    ...
    password: Yup.string()
      ...
      .max(12,"Password must not be more than 10 words")
    ...
    .min("Name must have atleat 1 letter")
    .max("Nmae should not be more than 20 letters")
    .required("First name is required"),
    lastName: Yup.string()
    .trim('The contact name cannot include leading and trailing spaces')
    .min("Name must have atleat 1 letter")
    .max("Name should not be more than 20 letters")
